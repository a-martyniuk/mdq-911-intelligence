...
const GANG_PROFILES: GangProfile[] = [
  {
    id: "ciclomotor_110",
    name: "Célula 'Ciclomotor 110cc / Wave / ZB' (Abordaje Urbano)",
    shortDesc: "Abordajes rápidos de 2 masculinos en rodados de baja cilindrada sobre avenidas y calles comerciales.",
    icon: "🛵",
    badgeColor: "#ef4444",
    linkedIncidentsCount: 1280,
    weaponsUsed: ["Pistola 9mm", "Revólver .38", "Arma de fuego corto"],
    vehicleTargets: ["Honda Wave 110", "Zanella ZB 110", "Motomel B110", "Gilera Smash"],
    peakHours: "18:00 - 24:00 hs (Noche)",
    attackZones: ["Av. Luro", "Av. Colón", "Av. San Martín", "Macrocentro"],
    escapeCorridors: ["Barrio Las Heras", "Barrio Autódromo", "Barrio Belgrano"],
    violenceLevel: "EXTREMO",
    matchPatternKeywords: ["110", "wave", "zb", "motomel", "gilera", "corven", "crypton"],
  ...
  {
    id: "tornado_alta",
    name: "Célula 'Motos Alta Cilindrada 250cc / Tornado / Rouser'",
    shortDesc: "Encierros armados a gran velocidad sobre corredores viales principales para robo de rodados de gama media/alta.",
    icon: "🏍️",
    badgeColor: "#ec4899",
    linkedIncidentsCount: 462,
    weaponsUsed: ["Pistola 9mm", "Escopeta recortada", "Arma de fuego"],
    vehicleTargets: ["Honda Tornado 250", "Rouser NS200", "Honda Twister", "Yamaha FZ"],
    peakHours: "20:00 - 02:00 hs (Nocturno / Madrugada)",
    attackZones: ["Av. Constitución", "Av. Juan B. Justo", "Av. Champagnat"],
    escapeCorridors: ["Barrio Regional", "Barrio Don Emilio", "Batán"],
    violenceLevel: "EXTREMO",
    matchPatternKeywords: ["tornado", "rouser", "twister", "250", "300", "duke", "xre", "fz", "xr"],
    rossmoAnchorZone: "Barrio Belgrano / Regional (Buffer B = 1.0 km)",
    hawkesRisk72h: "EXTREMO (91% Contagio en velocidad sobre Avenidas Colón y Luro)",
    signatureBehavior: "Intercepción de frente encerrando la marcha del rodado víctima",
  },
  {
    id: "levantadores_fiat",
    name: "Banda 'Levantadores de Fiat / Peugeot / Gol' (Apoyo & Desguace)",
    shortDesc: "Sustracción nocturna de vehículos populares estacionados en vía pública o cocheras para uso o desguace.",
    icon: "🚗",
    badgeColor: "#6366f1",
    linkedIncidentsCount: 2224,
    weaponsUsed: ["Sin uso de arma directa (Violación de cerrojo / Ganzúa)"],
    vehicleTargets: ["Fiat Uno", "Fiat Cronos", "Peugeot 208", "VW Gol", "Chevrolet Corsa"],
    peakHours: "18:00 - 04:00 hs (Noche / Madrugada)",
    attackZones: ["Macrocentro", "Chauvín", "La Perla", "Güemes"],
    escapeCorridors: ["Barrio Regional", "Barrio Don Emilio", "Zona Sur / Batán"],
    violenceLevel: "MEDIO",
    matchPatternKeywords: ["fiat", "peugeot", "gol", "corsa", "palio", "208", "cronos", "uno"],
    rossmoAnchorZone: "Barrio Regional / Don Emilio (Buffer B = 1.2 km)",
    hawkesRisk72h: "MEDIO (65% Probabilidad de réplica en 72 hs)",
    signatureBehavior: "Auto de apoyo VW Gol / Corsa Gris que encubre la sustracción en cocheras",
  },
  {
    id: "llave_corrida_pickups",
    name: "Banda 'Llave Corrida / Pickups 4x4' (Sustracción Silenciosa High-Value)",
    shortDesc: "Sustracción limpia mediante clonadores OBD e inhibidores de señal en áreas comerciales y de playa.",
    icon: "🔑",
    badgeColor: "#10b981",
    linkedIncidentsCount: 468,
    weaponsUsed: ["Inhibidores de señal RF / Lector OBD sin violencia"],
    vehicleTargets: ["Toyota Hilux", "Ford Ranger", "VW Amarok", "Toyota SW4"],
    peakHours: "12:00 - 18:00 hs (Tarde)",
    attackZones: ["Playa Grande", "Paseo Güemes", "Varese", "Puerto"],
    escapeCorridors: ["Ruta 2 salida a CABA", "Ruta 88 a Necochea"],
    violenceLevel: "MEDIO",
    matchPatternKeywords: ["hilux", "ranger", "amarok", "ram", "sw4", "frontier", "s10"],
    ...
    signatureBehavior: "Uso de inhibidores de frecuencia y portón/arranque electrónico rápido",
  },
  {
    id: "disparos_territorial",
    name: "Célula de Disparos / Abordajes Territoriales & Ajustes",
    shortDesc: "Agresiones armadas directas, ejecuciones de disparos a personas y vainas servidas en vía pública.",
    icon: "💥",
    badgeColor: "#f59e0b",
    linkedIncidentsCount: 2397,
    weaponsUsed: ["Pistolas 9mm", "Calibre .38", "Escopetas / Tumberas"],
    ...
    violenceLevel: "EXTREMO",
    matchPatternKeywords: ["disparo", "disparos", "vaina", "cartucho", "9mm", "herido"],
    rossmoAnchorZone: "Asentamiento Batán / Villa de Emergencia Libertad (Buffer B = 400m)",
    hawkesRisk72h: "EXTREMO (94% Contagiosidad por venganzas entre células en < 24 hs)",
    signatureBehavior: "Ataques directos a personas sin sustracción de rodado (Disputas de territorio)",
  },
  {
    id: "deliverys_bicis",
    name: "Célula 'Robo a Repartidores / Deliverys & Bicicletas'",
    shortDesc: "Sustracción a mano armada de rodados y equipamiento de trabajo a repartidores en franjas nocturnas.",
    icon: "🚲",
    badgeColor: "#8b5cf6",
    linkedIncidentsCount: 203,
    weaponsUsed: ["Arma Blanca / Cortante", "Pistola corta"],
    vehicleTargets: ["Bicicletas Rodado 29", "Motos 110cc de delivery", "Equipamiento"],
    peakHours: "19:00 - 01:00 hs (Noche)",
    attackZones: ["Macrocentro", "San José", "Plaza Mitre", "La Perla"],
    escapeCorridors: ["Pasajes hacia Barrio Pueyrredón / Parque Palermo"],
    violenceLevel: "ALTO",
    matchPatternKeywords: ["bici", "bicicleta", "rodado", "delivery", "pedidos", "rappi"],
    rossmoAnchorZone: "Corredor Gastronómico Macrocentro / San José (Buffer B = 600m)",
    hawkesRisk72h: "ALTO (78% Recurrencia en franjas pico de entregas gastronómicas)",
    signatureBehavior: "Emboscada en punto de entrega simulado con corte de paso a pie",
  },
  {
    id: "entraderas_cocheras",
    name: "Banda 'Entradas / Portones / Cocheras de Fincas'",
    shortDesc: "Abordaje en oportunidad de ingreso o egreso vehicular a fincas particulares y portones de edificios.",
    icon: "🏰",
    badgeColor: "#06b6d4",
    linkedIncidentsCount: 201,
    weaponsUsed: ["Armas de Fuego cortas", "Intimidación a víctimas"],
    vehicleTargets: ["Vehículos de alta gama", "Pertenencias familiares"],
    peakHours: "19:00 - 23:00 hs (Noche)",
    attackZones: ["Chauvín", "La Perla", "Güemes", "Caisamar"],
    escapeCorridors: ["Vías rápidas hacia Av. Champagnat"],
    violenceLevel: "ALTO",
    matchPatternKeywords: ["entradera", "cochera", "finca", "vivienda", "propiedad", "porton"],
    rossmoAnchorZone: "Barrio Chauvín / La Perla / Güemes (Buffer B = 1.5 km)",
    hawkesRisk72h: "MEDIO (60% Recurrencia por oportunidad de portón abierto)",
    signatureBehavior: "Reducción de ocupantes al momento del cierre del portón automatizado",
  },
];

...
export default function SectionDictionary({ currentProject = "mdp" }: SectionDictionaryProps) {
  ...
  const dictionaryData: (DictionaryItem & { proyecto?: string })[] = [
    ...
    { campo: "partido", tipo: "string", descripcion: "Municipio donde radica la competencia judicial y policial de la intervención.", ejemplo: "JOSÉ C. PAZ, MALVINAS ARGENTINAS", categoria: "narcocriminalidad", proyecto: "narcocriminalidad" },
